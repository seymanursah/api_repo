 ...
 */
    ...
    public void get10d() {
        ...
        Map<String, Object> expectedData = new HerOkuAppTestData().expectedDataMethod("Jane", "Doe", 111, true, bookingdatesMap, "Extra pillows please");  //To put data here is not recommended.
